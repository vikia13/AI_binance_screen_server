...
class TechnicalIndicators:
    ...
    def __init__(self, db_path='data', db_manager=None):
    ...
    def _init_database(self):
        """Initialize database tables for technical indicators"""
        if not self.db_manager:
            logger.error("Database manager not provided to TechnicalIndicators")
            return
        ...
        self.db_manager.execute_query(
            'technical_analysis',
            'CREATE INDEX IF NOT EXISTS idx_indicator_lookup ON indicators (symbol, timeframe, timestamp)'
        )
