...
class TechnicalIndicators:
    ...
    def calculate_indicators(self, symbol: str, timeframe: str = '1h', limit: int = 100) -> Optional[Dict[str, Any]]:
        ...
        # Fix type annotation issue by using explicit params dictionary
    ...
    def _get_price_changes(self, symbol: str) -> Dict[str, float]:
        ...
        result = {}
        # This timestamp calculation is used directly in the query below
        ...
        for tf_name, tf_ms in timeframes.items():
            ...
            if historical:
                ...
                if historical_volume > 0:
                    volume_change = ((latest_volume - historical_volume) / historical_volume) * 100
