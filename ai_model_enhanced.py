...
class EnhancedAIModel:
    ...
    def _init_database(self):
        """Initialize database tables for AI model"""
        if not self.db_manager:
            logger.error("Database manager not provided to EnhancedAIModel")
            return
        ...
        self.db_manager.execute_query(
            'ai_model',
            'CREATE INDEX IF NOT EXISTS idx_predictions_lookup ON predictions (model_name, symbol, timeframe)'
        )

        logger.info("AI model database initialized")
